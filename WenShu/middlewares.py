...
class WenshuDownloaderMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        request.headers['User-Agent'] = getattr(UserAgent(), 'random')
        # request_url = 'http://wenshu.court.gov.cn/List/ListContent'
        # if request.url == request_url:
        #     headers = {"User-Agent": request.headers['User-Agent']}
        #     result = requests.get(
        #         "http://tvp.daxiangdaili.com/ip/?tid=557485331689053&num=1&operator=1&delay=1&category=2",
